...
export const productos: Record<string, Producto> = {
  couva: {
    ...
    gallery: [`${P('couva')}/couva-1.jpg`, `${P('couva')}/couva-2.jpg`, `${P('couva')}/couva-6.jpg`, `${P('couva')}/couva-3.webp`, `${P('couva')}/couva-4.webp`, `${P('couva')}/couva-5.webp`],
  ...
  macao: {
    ...
    gallery: [`${P('macao')}/macao-1.jpg`, `${P('macao')}/macao-2.jpg`, `${P('macao')}/macao-3.jpg`, `${P('macao')}/macao-4.jpg`, `${P('macao')}/macao-5.jpg`],
